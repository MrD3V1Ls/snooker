<template>
        ...
        <div class="responsive-wrapper">
            <div class="content">
                <div class="content-main">
                    <div class="card-grid">
                        <div class="player" v-for="(track, index) in tracks" :key="index">
                            <div class="player__top">
                                <div class="player-cover">
                                    <transition-group :name="transitionName">
                                        <div class="player-cover__item" :style="{ backgroundImage: `url(${track.cover})` }">
                                        </div>
                                    </transition-group>
                                </div>
                            </div>
                            <div class="album-play">
                                <div class="album-info" v-if="currentTrack">
                                    <div class="album-info__name">{{ track.name }}</div>
                                    <div class="album-info__track">{{ track.artist }}</div>
                                </div>
                                <div class="player-controls__item -xl js-play" @click="play(track)">
                                    <svg class="icon">
    ...
    <iframe title="Amazon 1" width="1140" height="541.25"
        src="https://app.powerbi.com/reportEmbed?reportId=03dbacc5-6b30-4de9-83cb-47d37e085670&autoAuth=true&ctid=5f6bbd87-af21-4ce7-a02d-b5f2f06d8180"
